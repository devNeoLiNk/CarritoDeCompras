...
// Mostrando cursos que estan guardados en localStorage
const documentoCargado = document.addEventListener('DOMContentLoaded', () => {
...
function carritoHTML() {
  ...
  // Agregar contenido carrito a localStorage
